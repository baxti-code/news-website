...
from .views import News_List, HomePageView, ContactPageView, PageView404, SinglePageView, CategoryPageView, NewsUpdateView, NewsDeleteView, NewsCreateView, search
